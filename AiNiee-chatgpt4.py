...
from qfluentwidgets import CheckBox, InfoBar, InfoBarPosition, NavigationWidget, SpinBox, ComboBox, LineEdit, PrimaryPushButton, PushButton ,StateToolTip, SwitchButton, TextEdit, Theme, setTheme ,isDarkTheme, NavigationInterface,NavigationItemPosition
...
Software_Version = "AiNiee-chatgpt4.10"  #软件版本号
...
OpenAI_frequency_penalty = 1.0 #AI的频率惩罚，限制词语重复出现的频率。0.0是不惩罚，2.0是最大惩罚，-2.0是最大奖励
...
Account_Type = ""  #账号类型
#设置多维列表，用来存储：平台启用状态；账号类型；模型类型；API Key；代理地址
