...
from PyQt5.QtCore import Qt, pyqtSignal, QUrl, QObject, QTimer # QTimer for delayed set_path if needed
from PyQt5.QtGui import QDragEnterEvent, QDropEvent, QDragMoveEvent, QColor, QFontMetrics, QFont
    ...
    def _set_style_state(self, state="idle", path=""):
        ...
        if dark_mode:
            colors = {
                ...
                "success":  {"bg": "rgba(80, 95, 80, 0.7)", "border": "#7ec77e", "text": "#e0e0e0", "style": "solid"},
...
class FolderDropCard(CardWidget):
    ...
    # 参数： self (FolderDropCard instance), path (str)
    ...
    def __init__(self,title: str,prompt_text: str = "none",initial_path: str = None,path_dropped_callback=None, parent=None):
        ...
        self.folder_drop_label.setMinimumSize(900, 350) # 设置最小宽度与高度
