...
def Request_test():
    ...
    if not API_key  :
        ...
        worker.update_signal.emit("Null_value")
        return 0
...
def Main():
    ...
    global keyList_len ,result_str ,  Failure_translate_str ,  Translation_Status_List , money_used,source,source_mid,result_dict,Translation_Progress
    ...
    with open(file_name, 'r',encoding="utf-8") as f:               
        ...
        result_dict = source_mid # 用字典类型存储每次请求的译文
